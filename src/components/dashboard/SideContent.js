...
const data = [{
    ...
    type:'folder',
    date:'20 oct ',
    content:[{...structure,type:'file',name:'filee'},{...structure,name:'folder2',content:[{...structure,type:'file',name:'filee'}]}]
      ...
      <Box>
                  ...
                  <Box>
                    <div className="d-flex justify-content-between align-items-center mt-2 px-2">
                        ...
                        <Button leftIcon={<AiOutlineCloudUpload size={'25px'} />}  variant={'ghost'} >Upload</Button>
